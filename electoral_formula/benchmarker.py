...
# class Logger:
#     def __init__(self, folder_path, batch_no, formula, n_runs):
#         regs = REGS
#         self.tot_nat_amend_stats = {
#             "max_diff_seats": 0,
#             "mean_diff_seats": 0,
#             "min_diff_seats": 0,
#             "max_diff_perc": 0,
...
#         }
#         for reg in regs:
#             self.files_dict[reg] = open(f"{folder_path}/reg_{reg}_{batch_no}.csv", "w")
#
#         self.n_runs = n_runs
#         self.formula = formula
#
#     def log(self, df, stats, formula):
#         pass
#
#     def finish(self):
...
def increasing_votes_exp(
    ...
    perc_step = (end_perc - start_perc) / (n_runs - 1)
...
def increasing_votes_exp_old(
    ...
    is_orig = "original" in formula
    is_amend = "amend" in formula
